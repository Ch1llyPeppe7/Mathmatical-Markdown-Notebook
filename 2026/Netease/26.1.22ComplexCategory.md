...
> **插图占位符**：此处需要插入单纯复形的可视化图，展示0-3维单纯形，以及复形作为超图的结构。
...
> **插图占位符**：此处需要插入有向加权复形的可视化图，展示有向边、权重标注，以及从交互序列到复形的构造过程。

![有向加权复形](images/figure5_weighted_directed_complex.png)
</blockquote>
...
> **插图占位符**：此处需要插入拉回构造的交换图，展示 $K \to M$、$L \to M$ 以及拉回 $K \times_M L$ 的构造过程。

![拉回构造交换图](images/figure6_commutative_diagrams.png)
</blockquote>
...
> **插图占位符**：此处需要插入推出构造的交换图，展示 $M \to K$、$M \to L$ 以及推出 $K \sqcup_M L$ 的构造过程。

![推出构造交换图](images/figure6_commutative_diagrams.png)
</blockquote>
